...
- [x] **Mise à jour v14 (Mars 2026)** : Déduplication sémantique par ID officiel, filtrage auto-adaptatif (hors-domaine, verbes normatifs) dérivé du contexte Markdown.
