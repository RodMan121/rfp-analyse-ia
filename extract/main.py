...
def run_ingestion(
    input_path: str, db_path: str = None, collection_name: str = "rfp_hierarchical"
):
    ...
    factory_logger.log_event(
        "PHASE_1", "COMPLETED", f"{len(fragments)} fragments atomiques indexés."
    )
    console.print(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--collection", default="rfp_hierarchical", help="Nom de la collection"
    )
